        ...
        <form  class="signform"action="/examples/actions/confirmation.php" method="post" onSubmit={submitForm}>
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id='fname' name="username" placeholder="Fullname" onChange={handleUser} value={username} required="required"></input>
                </div>
                </div>
            <div class="form-group">
                <div class="input-group">
            ...
            <div class="form-group">
                ...
                {passError?<p className="error">Password must be more than 5 character</p>:null}
            </div>
            <div class="form-group">
                <div class="input-group">
            ...
            <div class="form-group">
                <button type="submit"  class="btn btn-primary btn-block btn-lg " style={{color:"white"}}>Sign Up</button>
                <button onClick={resetData} type="submit" class="btn btn-danger btn-block btn-lg" style={{color:"white"}}>Reset</button>
            </div>
